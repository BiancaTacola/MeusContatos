...
import br.com.fiap.meuscontatos.database.dao.repository.ContatoRepository
    ...
    Card(
        ...
        Row(
            ...
            IconButton(onClick = {
                ...
                // Adicione a lógica de exclusão do contato aqui, se necessário
                val contatoRepository = ContatoRepository(context)
                contatoRepository.excluir(contato)

                // Após excluir, chame a função atualizar para manter a lista atualizada
                atualizar()
